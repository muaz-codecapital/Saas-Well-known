        ...
        <form id="addStatusForm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addStatusModalLabel"><?php echo e(__('Add New Status')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="status_name"><?php echo e(__('Status Name')); ?></label>
                        <input type="text" class="form-control" id="status_name" name="status_name" required>
                    </div>
                    <div class="form-group">
                        <label for="status_class"><?php echo e(__('Status Class')); ?></label>
...
<script>
    ...
    document.getElementById('addStatusForm').addEventListener('submit', function(e) {
        ...
        $.post("<?php echo e(route('tasks.addStatus')); ?>", {
...
<?php /**PATH /home/freylphj/suiteup.grsventures.ltd/resources/views/tasks/add-status-model.blade.php ENDPATH**/ ?>