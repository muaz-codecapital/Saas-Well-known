<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0  fixed-left " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="<?php echo e(config('app.url')); ?>/dashboard">
    ...
    <div class="collapse navbar-collapse  w-auto  d-print-none " id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <?php if(empty($modules) || in_array('to_dos',$modules)): ?>
                ...
                <li class="nav-item ">
                    <a class="nav-link <?php if(($selected_navigation ?? '') === 'todos'): ?> active <?php endif; ?> "
                       href="<?php echo e(route('admin.tasks', ['action' => 'list'])); ?>">
...
<?php /**PATH /home/freylphj/suiteup.grsventures.ltd/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>