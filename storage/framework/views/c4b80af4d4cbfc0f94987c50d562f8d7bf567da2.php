                            ...
                            <div>
                                <div class="dropstart">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3"
                                        ...
                                        <li>
                                            <a class="dropdown-item border-radius-md" href="/export-project-pdf?id=<?php echo e($project->id); ?>">
...
<?php echo $__env->make('layouts.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\well-known\resources\views/projects/projects.blade.php ENDPATH**/ ?>