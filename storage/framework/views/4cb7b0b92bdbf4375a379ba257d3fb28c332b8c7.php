...
<head>
    ...
    <link id="pagestyle" href="<?php echo e(PUBLIC_DIR); ?>/css/app.css?v=2" rel="stylesheet"/>
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <?php if(!empty($super_settings['meta_description'])): ?>

        <meta name="description" content="<?php echo $super_settings['meta_description']; ?>" />
    <?php endif; ?>


    <?php if(!empty($super_settings['custom_script'])): ?>
        <?php echo $super_settings['custom_script']; ?>
    ...
    <div class="container mt-4 ">
        <div class="row">
            <div class="col-md-6 mb-4 ms-auto">
                ...
                <?php if(!empty($contact)): ?>
                    <h6  class="text-white"><?php echo e(__('Contact Us')); ?></h6>
                    <?php echo e($contact->address_1); ?>
                ...
                <ul class="flex-column ms-n3 nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/termsandconditions">
                            <h6 class="text-white text-sm"><?php echo e(__('Terms & Condition')); ?></h6>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class=" nav-link text-white" href="/privacy">
                            <h6 class="text-white text-sm"><?php echo e(__('Privacy Policy')); ?></h6>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class=" nav-link text-white" href="/cookie-policy">
                            <h6 class="text-white text-sm"><?php echo e(__('Cookie Policy')); ?></h6>
                        </a>
                    </li>
                    <li class="nav-item mt-6">
                        <a class=" nav-link text-white" href="#" target="_blank">
                            <h6 class="text-white text-sm"><?php echo e(__('Connect with us')); ?></h6>
                        </a>
                    </li>
                    <ul class="flex-row-reverse me-2 nav">
                        <?php if(!empty($contact)): ?>
                            <li class="nav-item">
                                <a class="nav-link pe-1 text-white" href="<?php echo e($contact->facebook); ?>" target="_blank">
                        ...
                        <?php if(!empty($contact)): ?>
                            <li class="nav-item">
                                <a class="nav-link pe-1 text-white" href="<?php echo e($contact->twitter); ?>" target="_blank">
                        ...
                        <?php if(!empty($contact)): ?>
                            <li class="nav-item">
                                <a class="nav-link pe-1 text-white" href="<?php echo e($contact->youtube); ?>" target="_blank">
            ...
            <div class="col-12">
                <div class="text-start">
                    <p class="my-4 text-sm">
                        ...
                        </script>  by  <?php if(!empty($contact)): ?>
                            <?php echo e($contact->title); ?>
...
<script src="<?php echo e(PUBLIC_DIR); ?>/js/app.js?v=93"></script>
...
<?php /**PATH /home/freylphj/suiteup.grsventures.ltd/resources/views/frontend/layout.blade.php ENDPATH**/ ?>