            ...
            <div class="col-lg-9 col-12 mx-auto">
                ...
                <div class="mb-2">
                    ...
                    <input
                            type="text"
                            name="tags"
                            value="{{ isset($note->tags) ? implode(',', json_decode($note->tags, true) ?? []) : old('tags') }}"
                            class="form-control"
                            id="tags"
                    >
                </div>
                ...
                <div class="mb-3 align-self-center">
                    <label for="workspace" class="form-label">{{ __('Select Workspace') }}</label>
                    <select name="workspace" id="workspace" class="form-control">
                        <option value="" disabled selected>{{ __('Choose a Workspace') }}</option>
                ...
                <div class="align-self-center mb-3">
                    <div>
                        <label for="reference_file" class="form-label mt-4">{{__('Upload Refrence File')}}</label>
